...
const ProductList: React.FC = () => {
  ...
  return (
    <div className="w-[90%] m-auto">
      ...
      {filteredProducts.length>0?<div className="p-1 m-auto grid grid-cols-1 auto-rows-auto  lg:grid-cols-4 md:grid-cols-2">
        {
        filteredProducts?.map((el, index) => {
          ...
          <img className="m-auto" src="https://www.lifecoachhub.com/files/images/no-product-found.png" alt="No Product"/>
        </div>}
